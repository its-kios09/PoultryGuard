...
class Shop extends ChangeNotifier {
  final List<PoultryModal> _productMenu = [
    ...
    PoultryModal(
        ...
        description:
            "Growel Gout Suraksha – Gout Supplements for Poultry, Pet Birds and Pigeons – 100 gm",
    ...
    PoultryModal(
        ...
        description:
            "Growel Viraclean - A powerful disinfectant for Aquaculture, Poultry, Cattle, Horses, Pigs, Goats, Sheep,Pigeons and Birds 150g",
